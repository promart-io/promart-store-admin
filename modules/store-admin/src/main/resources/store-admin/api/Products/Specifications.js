...
var dao = require('store-admin/data/dao/Products/Specifications');
var http = require('store-admin/api/http');
...
rs.service()
	...
	.resource('')
		.post(function(ctx, request, response) {
			...
			response.setHeader('Content-Location', '/services/v3/js/store-admin/api/Specifications.js/' + entity.Id);
