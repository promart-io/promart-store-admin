...
var dao = require('store-admin/data/dao/Nomenclatures/Categories');
...
rs.service()
	...
	.resource('')
		.post(function(ctx, request, response) {
			...
			response.setHeader('Content-Location', '/services/v3/js/store-admin/api/Categories.js/' + entity.Id);
