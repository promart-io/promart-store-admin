...
.factory('$messageHub', [function(){
	...
	var message = function(evtName, data){
		messageHub.post({data: data}, 'store-admin.Products.Products.' + evtName);
	};
	...
	return {
		...
		onEntityRefresh: function(callback) {
			on('store-admin.Products.Products.refresh', callback);
		},
		onUoMModified: function(callback) {
			on('store-admin.Products.UoM.modified', callback);
		},
		onCategoriesModified: function(callback) {
			on('store-admin.Products.Categories.modified', callback);
		},
		onCurrenciesModified: function(callback) {
			on('store-admin.Products.Currencies.modified', callback);
		},
...
.controller('PageController', function ($scope, $http, $messageHub) {
	...
	var api = '../../../../../../../../../../services/v3/js/store-admin/api/Products/Products.js';
	var uomidOptionsApi = '../../../../../../../../../../services/v3/js/store-admin/api/Nomenclatures/UoM.js';
	var categoryidOptionsApi = '../../../../../../../../../../services/v3/js/store-admin/api/Nomenclatures/Categories.js';
	var currencyidOptionsApi = '../../../../../../../../../../services/v3/js/store-admin/api/Nomenclatures/Currencies.js';
