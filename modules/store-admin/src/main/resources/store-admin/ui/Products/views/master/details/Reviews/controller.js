...
.factory('$messageHub', [function(){
	...
	var message = function(evtName, data){
		messageHub.post({data: data}, 'store-admin.Products.Reviews.' + evtName);
	};
	...
	return {
		...
		onEntityRefresh: function(callback) {
			on('store-admin.Products.Reviews.refresh', callback);
		},
...
.controller('PageController', function ($scope, $http, $messageHub) {
	...
	var api = '../../../../../../../../../../services/v3/js/store-admin/api/Products/Reviews.js';
