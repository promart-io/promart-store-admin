...
.factory('$messageHub', [function(){
	...
	var message = function(evtName, data){
		messageHub.post({data: data}, 'store-admin.Site.Marketplace.' + evtName);
	};
	...
	return {
		...
		onEntityRefresh: function(callback) {
			on('store-admin.Site.Marketplace.refresh', callback);
		},
...
.controller('PageController', function ($scope, $http, $messageHub) {
	...
	var api = '../../../../../../../../../../services/v3/js/store-admin/api/Site/Marketplace.js';
