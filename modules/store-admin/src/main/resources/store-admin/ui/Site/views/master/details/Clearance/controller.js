...
.factory('$messageHub', [function(){
	...
	var message = function(evtName, data){
		messageHub.post({data: data}, 'store-admin.Site.Clearance.' + evtName);
	};
	...
	return {
		...
		onEntityRefresh: function(callback) {
			on('store-admin.Site.Clearance.refresh', callback);
		},
...
.controller('PageController', function ($scope, $http, $messageHub) {
	...
	var api = '../../../../../../../../../../services/v3/js/store-admin/api/Site/Clearance.js';
